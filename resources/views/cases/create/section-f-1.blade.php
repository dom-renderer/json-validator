<form id="form-section-f-1">
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <select class="form-select" name="purpose" id="s-f-1-purpose" multiple required>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" rows="3" name="additional_details" required> {{ $f1Data->additional_details ?? '' }} </textarea>
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="estimated_networth" value="{{ $f1Data->estimated_networth ?? '' }}" required>
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" rows="2" name="source_of_wealth_for_policy" required>{{ $f1Data->source_of_wealth_for_policy ?? '' }}</textarea>
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" rows="2" name="distribution_strategy_during_policy_lifetime" required>{{ $f1Data->distribution_strategy_during_policy_lifetime ?? '' }}</textarea>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" rows="2" name="distribution_strategy_post_death_payout" required>{{ $f1Data->distribution_strategy_post_death_payout ?? '' }}</textarea>
            <small class="text-muted">
